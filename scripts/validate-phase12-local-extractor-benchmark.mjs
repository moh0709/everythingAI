...
requireText(adapterFile, 'LayoutObjectDetectionOptions.from_preset');
requireText(adapterFile, 'layout_options.model_spec.model_copy');
requireText(adapterFile, 'update={"revision": heron["revision"]}');
requireText(adapterFile, 'LAYOUT_MODEL_REVISION_MISMATCH');
